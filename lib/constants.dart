...
ThemeData careTheme() => ThemeData(
  fontFamily: 'Roboto',
  colorScheme: const ColorScheme.light(primary: kTeal, secondary: kTealDark),
  ...
  appBarTheme: const AppBarTheme(
    ...
    titleTextStyle: TextStyle(color: kTextDark, fontWeight: FontWeight.w800, fontSize: 18),
  ),
  inputDecorationTheme: InputDecorationTheme(
    filled: true,
    fillColor: const Color(0xFFF5F8F8),
    border:        OutlineInputBorder(borderRadius: BorderRadius.circular(kRadiusSmall), borderSide: const BorderSide(color: Color(0xFFE0EEEE))),
    enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(kRadiusSmall), borderSide: const BorderSide(color: Color(0xFFE0EEEE))),
    focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(kRadiusSmall), borderSide: const BorderSide(color: kTeal, width: 2)),
    errorBorder:        OutlineInputBorder(borderRadius: BorderRadius.circular(kRadiusSmall), borderSide: const BorderSide(color: kDanger)),
    focusedErrorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(kRadiusSmall), borderSide: const BorderSide(color: kDanger, width: 2)),
