    ...
    setState(() {
      _liste = [
        Prescription(
          ...
          message: 'Prendre 3x/jour après les repas.',
          dateDebut: DateTime(2026, 2, 1),
          dateFin: DateTime(2026, 2, 28),
        ),
        Prescription(
          id: 2,
          patientId: widget.patient.id,
          ...
          message: 'En cas de douleur uniquement.',
        ...
        Prescription(
          ...
          message: 'Matin et soir après les repas.',
          dateDebut: DateTime(2026, 2, 15),
          dateFin: DateTime(2026, 2, 22),
        ),
        Prescription(
          id: 4,
          patientId: widget.patient.id,
          ...
          medecinNom: Session.nom ?? 'Médecin',
          specialite: 'Ophtalmologue',
          medicament: 'Vitamine D3',
          message: 'Une dose par semaine.',
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    ...
                    label: const Text('Ajouter une prescription'),
                  ),
                ],
              ),
            )
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        '${_fmt(p.dateDebut)} → ${_fmt(p.dateFin)}',
                                        style: const TextStyle(
                                          color: kTextSub,
                                          fontSize: 11,
                                        ),
...
class _FormPrescription extends StatefulWidget {
  ...
  @override
  State<_FormPrescription> createState() => _FormPrescriptionState();
}
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                maxLines: 3,
                decoration: const InputDecoration(
                  hintText: 'Message du médecin pour le patient...',
                ),
              ),
              const SizedBox(height: 16),
              const Align(
              ...
              Row(
                children: [
                  Expanded(
                    child: _BtnDate('Début', _fd(_debut), () => _pick(true)),
                  ),
                  const Padding(
                  ...
                  Expanded(
                    child: _BtnDate('Fin', _fd(_fin), () => _pick(false)),
                  ),
                ],
              ),
              if (_err != null)
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        if (_med.text.trim().isEmpty ||
                            ...
                            _fin == null) {
                          setState(
                            () => _err = 'Médicament et période obligatoires.',
                          );
                          return;
                        }
                        Navigator.pop(
